    ...
    <div className="min-h-screen bg-black text-white font-sans selection:bg-white selection:text-black overflow-x-hidden relative">
      ...
      <section className="relative z-10 pt-32 pb-24 px-6 text-center max-w-5xl mx-auto">
        ...
        <div className="relative mx-auto max-w-4xl perspective-1000">
          <div className="relative bg-black/40 border border-white/10 rounded-xl overflow-hidden shadow-2xl backdrop-blur-md transform rotate-x-12 hover:rotate-0 transition-transform duration-700 ease-out p-1">
            {/* Window Controls */}
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Feature 1: BYOM */}
          <div className="lg:col-span-2 p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl hover:bg-white/[0.07] transition-colors group">
          ...
          <div className="p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl hover:bg-white/[0.07] transition-colors">
          ...
          {/* Feature 4: Policy */}
          <div className="lg:col-span-2 p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl hover:bg-white/[0.07] transition-colors flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1">
