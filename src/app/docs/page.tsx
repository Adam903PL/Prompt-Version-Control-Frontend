    ...
    <div className="space-y-12 pb-20">
      ...
      <div className="space-y-8">
        ...
        <section id="init" className="space-y-3 pt-4">
          <h3 className="text-xl font-medium text-white font-mono">pvc init</h3>
          <p className="text-gray-400">Initialize PVC in current directory.</p>
        </section>
        ...
        <section id="update-conv" className="space-y-3 pt-4">
          ...
          <p className="text-gray-400">
            ...
            directory to find the latest session and updates the configuration.
          </p>
          <div className="bg-zinc-950 border border-white/10 rounded-lg p-4 font-mono text-sm text-gray-300">
            pvc update-conv
          </div>
        ...
        <section id="generate" className="space-y-3 pt-4">
          ...
          <div className="space-y-2 mt-4">
            <h4 className="text-white font-medium">Include last N messages</h4>
            <div className="bg-zinc-950 border border-white/10 rounded-lg p-4 font-mono text-sm text-gray-300">
        ...
        <section id="push" className="space-y-3 pt-4">
          <h3 className="text-xl font-medium text-white font-mono">pvc push</h3>
          <p className="text-gray-400">
        ...
        <section id="risk" className="space-y-3 pt-4">
          <h3 className="text-xl font-medium text-white font-mono">pvc risk</h3>
          <p className="text-gray-400">
